...
export const RACE_EVENTS: RaceEvent[] = [
  ...
  },
  {
    ...
    description:
      'The championship-deciding Grand Prix finale over Tokyo Bay. With Mount Fuji visible on clear days, this is the most prestigious round of the season — every point counts.',
  ...
  },
  {
    ...
    description:
      'A spectacular exhibition event above the Dubai Marina skyline. Featuring night flying with illuminated pylons — strictly non-championship but draws the largest global audience.',
